      ...
      <div class="flex flex-col flex-shrink-0 w-full">
        ...
        <nav>
          <div class="flex-grow md:block md:overflow-y-auto overflow-x-hidden" :class="{'opacity-1': sidebarOpen, 'opacity-0': !sidebarOpen}">
            ...
            <a class="flex items-center px-4 py-3 hover:bg-gray-800 focus:bg-gray-800 hover:text-gray-400 focus:outline-none focus:ring {{ request()->is('dashboard/orders*') ? 'bg-gray-800' : '' }}" href="{{ route('dashboard.orders') }}">
  ...
  <div :class="{'ml-56': sidebarOpen, 'ml-0' : !sidebarOpen }" class="flex-col w-full ml-56 transition-all duration-300 md:flex md:flex-col min-h-screen">
    <div class="p-10">
      ...
      <div class="flex items-end justify-end absolute bottom-0 right-0 mb-5 mr-5">
        <div>
          <a title="Buy me a coffee" href="https://www.buymeacoffee.com/rHcLDkY" target="_blank" class="block w-14 h-14">
